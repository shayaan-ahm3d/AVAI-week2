...
dip_noise_01.drop(columns=["sample", "num_patches", "baseline_psnr", "baseline_ssim", "baseline_lpips"], inplace=True, errors='ignore')
inr_noise_01 = pd.read_csv(inr_noise_01)
inr_noise_01.drop(columns=["image", "loss", "baseline_psnr", "baseline_ssim", "baseline_lpips"], inplace=True, errors='ignore')
...
dip_noise_02.drop(columns=["sample", "num_patches", "baseline_psnr", "baseline_ssim", "baseline_lpips"], inplace=True, errors='ignore')
inr_noise_02 = pd.read_csv(inr_noise_02)
inr_noise_02.drop(columns=["image", "loss", "baseline_psnr", "baseline_ssim", "baseline_lpips"], inplace=True, errors='ignore')
...
dip_noise_03.drop(columns=["sample", "num_patches", "baseline_psnr", "baseline_ssim", "baseline_lpips"], inplace=True, errors='ignore')
inr_noise_03 = pd.read_csv(inr_noise_03)
inr_noise_03.drop(columns=["image", "loss", "baseline_psnr", "baseline_ssim", "baseline_lpips"], inplace=True, errors='ignore')
...
dip_noise_04.drop(columns=["sample", "num_patches", "baseline_psnr", "baseline_ssim", "baseline_lpips"], inplace=True, errors='ignore')
inr_noise_04 = pd.read_csv(inr_noise_04)
inr_noise_04.drop(columns=["image", "loss", "baseline_psnr", "baseline_ssim", "baseline_lpips"], inplace=True, errors='ignore')
...
dip_noise_05.drop(columns=["sample", "num_patches", "baseline_psnr", "baseline_ssim", "baseline_lpips"], inplace=True, errors='ignore')
inr_noise_05 = pd.read_csv(inr_noise_05)
inr_noise_05.drop(columns=["image", "loss", "baseline_psnr", "baseline_ssim", "baseline_lpips"], inplace=True, errors='ignore')
...
dip_x16_pd.drop(columns=["sample", "num_patches", "baseline_psnr", "baseline_ssim", "baseline_lpips"], inplace=True, errors='ignore')
inr_x16_pd = pd.read_csv(inr_x16)
inr_x16_pd.drop(columns=["image", "loss", "baseline_psnr", "baseline_ssim", "baseline_lpips"], inplace=True, errors='ignore')
...
dip_pd.drop(columns=["sample", "num_patches", "baseline_psnr", "baseline_ssim", "baseline_lpips"], inplace=True, errors='ignore')
inr_pd = pd.read_csv(inr)
inr_pd.drop(columns=["image", "loss", "baseline_psnr", "baseline_ssim", "baseline_lpips"], inplace=True, errors='ignore')
